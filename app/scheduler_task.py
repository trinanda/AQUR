...
def update_tuition_payment_status():
    ...
    with app.app_context():
        ...
        for data in payment:
            ...
            if str(one_month_later_after_pay_at) == current_time \
                and str(data.status_of_payment) == PaymentStatus.COMPLETED.value:
                data.status_of_payment = PaymentStatus.EXPIRED.value
